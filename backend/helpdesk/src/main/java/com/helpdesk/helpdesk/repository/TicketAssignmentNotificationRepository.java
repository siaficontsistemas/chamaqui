...
public interface TicketAssignmentNotificationRepository extends JpaRepository<TicketAssignmentNotification, UUID> {
	...
	List<TicketAssignmentNotification> findVisibleByRecipientEmailOrderByCreatedAtDesc(@Param("email") String email);
